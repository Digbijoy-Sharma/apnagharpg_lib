...
$config['smtp_user']        	= 	'';	//	This is where you change email address for personalizing email service
$config['smtp_pass']        	= 	'';		//	This is where you change app password for personalizing email service
