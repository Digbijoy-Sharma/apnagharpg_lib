...
<div id="content" class="content">
    ...
    <div class="btn-group pull-right">
        <a href="<?php echo base_url(); ?>daily_cash_book" class="btn btn-primary">
            <i class="fa fa-book"></i> Daily Cash Book
        </a>
        <a href="<?php echo base_url(); ?>purchases" class="btn btn-warning">
            <i class="fa fa-shopping-cart"></i> Purchases
        </a>
        <a href="<?php echo base_url(); ?>bank_statements" class="btn btn-success">
                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>Collected Plan Revenue</th>
                                <th>Due Plan Revenue</th>
