...
<?php echo form_open_multipart('expenses/update/' . $param2, array('id' => 'edit_expense', 'method' => 'post', 'data-parsley-validate' => 'true')); ?>
<?php
...
?>
	...
	<div class="form-group">
		...
		<input type="file" name="image_link" class="form-control" accept=".jpg,.jpeg,.png">
	</div>
